...
public class AddEmployeeSteps extends CommonMethods {
    ...
    /*SoftAssert soft= new SoftAssert();*/
            ...
            WebElement middleNameCheck = driver.findElement (By.id ( "personal_txtEmpMiddleName" ));
            WebElement lastNameCheck = driver.findElement (By.id ( "personal_txtEmpLastName" ));
            soft.assertEquals ( firstNameCheck.getAttribute ( "value" ), mapNewEmp.get ( "firstName" ) );
            soft.assertEquals ( middleNameCheck.getAttribute ( "value" ), mapNewEmp.get ( "middleName" ) );
            soft.assertEquals ( lastNameCheck.getAttribute ( "value" ), mapNewEmp.get ( "lastName" ) );*/
    /*soft.assertAll();*/
